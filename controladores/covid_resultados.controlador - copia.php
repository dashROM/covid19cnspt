...
class ControladorCovidResultados {
	...
	static public function ctrCrearCovidResultado() {
		...
		if (isset($_POST["nuevaFechaRecepcion"])) {
			...
			if (preg_match($patron_numerosTexto, $_POST["nuevoTipoMuestra"]) &&
				...
				preg_match($patron_numerosTexto, $_POST["nuevaZona"]) &&
				preg_match($patron_numerosTexto, $_POST["nuevaCalle"])) {
	...
	static public function ctrEditarCovidResultado() {
		...
		if (isset($_POST["editarFechaRecepcion"])) {
			...
			if (preg_match($patron_numerosTexto, $_POST["editarTipoMuestra"]) &&
				preg_match($patron_numerosLetras, $_POST["editarDocumentoCI"]) &&
				preg_match($patron_numerosTexto, $_POST["editarZona"]) &&
				preg_match($patron_numerosTexto, $_POST["editarCalle"])) {
						...
						swal.fire({
							...
							confirmButtonText: "¡Cerrar!"
		  					...
		  					if (result.value) {
								...
								window.location = "index.php?ruta=editar-covid-resultado&idCovidResultado="'+$_POST["idCovidResultado"]+';
							}
