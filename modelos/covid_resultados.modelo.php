...
class ModeloCovidResultados {
	...
	static public function mdlContarCovidResultadosLab($where, $tabla) {
	...
	static public function mdlContarMostrarResultadosLab($where, $colum, $order, $start, $length, $tabla) {

		// devuelve el numero de registros de la vista mostrar_covid_resultados

		$sql = "SELECT * FROM $tabla $where ORDER BY $colum $order LIMIT $start, $length";
