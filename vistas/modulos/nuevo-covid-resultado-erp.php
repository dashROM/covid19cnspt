      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <h1 class="m-0 text-dark">
            ...
            Nuevo Registro COVID-19 (Datos ERP)
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-5 col-md-5 col-lg-5">
                          ...
                          <div class="form-group">
                            ...
                            <label>Fecha Nacimiento</label> (<i class="fas fa-asterisk asterisk mr-1"></i>)
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <label>N° Documento - CI</label> (<i class="fas fa-asterisk asterisk mr-1"></i>)
                          
                          <div class="input-group">

                            <input type="number" class="form-control" name="documento" id="documento" placeholder="50333...">
            ...
            <form role="form" method="post" enctype="multipart/form-data" class="formularioNuevoRegCovid19">
              ...
              <div class="card-body">                
                ...
                <div class="col-md-12 callout callout-info">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control form-control-sm mayuscula" id="nuevoPaterno" name="nuevoPaterno" readonly required>
                    </div>

                    <div class="form-group col-md-4">
                      <label for="nuevoMaterno">Apellido Materno</label>
                      <input type="text" class="form-control form-control-sm mayuscula" id="nuevoMaterno" name="nuevoMaterno" readonly required>
                    </div>

                    <div class="form-group col-md-4">
                      <label for="nuevoNombre">Nombre</label>
                      <input type="text" class="form-control form-control-sm mayuscula" id="nuevoNombre" name="nuevoNombre" readonly required>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      <label for="nuevoDocumentoCI">Nro. CI</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                      <input type="text" class="form-control form-control-sm" id="nuevoDocumentoCI" name="nuevoDocumentoCI" readonly>
                    </div>

                    <div class="form-group col-md-4">
                      <label for="nuevoSexo">Sexo</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                      <select class="form-control form-control-sm" id="nuevoSexo" name="nuevoSexo" data-dropdown-css-class="select2-info" style="width: 100%;" readonly>
                      </select>
                    </div>

                    <div class="form-group col-md-4">
                      <label for="nuevaFechaNacimiento">Fecha de Nacimiento</label>
                      <input type="date" class="form-control form-control-sm" id="nuevaFechaNacimiento" name="nuevaFechaNacimiento" readonly>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      <label for="nuevaLocalidad">Localidad</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevaZona">Zona</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevaCalle">Calle</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                ...
                <div class="col-md-12 callout callout-info">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevaFechaMuestra">Fecha Toma de Muestra</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                      <input type="date" class="form-control form-control-sm" id="nuevaFechaMuestra" name="nuevaFechaMuestra" required>
                    </div>
                    
                    <div class="form-group col-md-3">
                      <label for="nuevaMuestraControl">Muestra de Control</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <label for="nuevoTipoMuestra">Tipo de muestra tomada</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevaFechaRecepcion">Fecha Recepción</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-2">
                      <label for="nuevoCodLab">Cód. Lab.</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevoDepartamento">Departamento</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                    ...
                    <div class="form-group col-md-4">
                      <label for="nuevoEstablecimiento">Establecimiento</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
                ...
                <div class="col-md-12 callout callout-info">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <label class="m-0" for="nuevoMetodoDiagnostico">Método de Diagnostico(<i class="fas fa-asterisk asterisk mr-1"></i>)</label>
                    ...
                    <div class="form-group col-md-3">
                      <label for="nuevaFechaResultado">Fecha del Resultado</label>(<i class="fas fa-asterisk asterisk mr-1"></i>)
              ...
              <div class="card-footer">
                ...
                <div class="float-right">
                  ...
                  <input type="hidden" id="codAfiliado" name="codAfiliado">

                  <input type="hidden" id="codAsegurado" name="codAsegurado">

                  <input type="hidden" id="codEmpleador" name="codEmpleador">

                  <input type="hidden" id="idAfiliado" name="idAfiliado" value="1">
